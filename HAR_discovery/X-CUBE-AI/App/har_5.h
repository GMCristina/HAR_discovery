...
/******************************************************************************/
#define AI_HAR_5_MODEL_NAME          "har_5"
#define AI_HAR_5_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_HAR_5_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_HAR_5_IN_NUM        (1)
#define AI_HAR_5_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 90, 3, 1, 1, NULL), \
}
#define AI_HAR_5_IN_SIZE { \
  AI_HAR_5_IN_1_SIZE, \
}
#define AI_HAR_5_IN_SIZE_BYTES { \
  AI_HAR_5_IN_1_SIZE_BYTES, \
}
#define AI_HAR_5_IN_1_HEIGHT      (90)
#define AI_HAR_5_IN_1_WIDTH       (3)
#define AI_HAR_5_IN_1_CHANNEL     (1)
#define AI_HAR_5_IN_1_SIZE        (90 *  3 *  1)
#define AI_HAR_5_IN_1_SIZE_BYTES  (AI_HAR_5_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_HAR_5_OUT_NUM       (1)
#define AI_HAR_5_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 6, 1, NULL), \
}
#define AI_HAR_5_OUT_SIZE { \
  AI_HAR_5_OUT_1_SIZE, \
}
#define AI_HAR_5_OUT_SIZE_BYTES { \
  AI_HAR_5_OUT_1_SIZE_BYTES, \
}
#define AI_HAR_5_OUT_1_CHANNEL     (6)
#define AI_HAR_5_OUT_1_SIZE        (6)
#define AI_HAR_5_OUT_1_SIZE_BYTES  (AI_HAR_5_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_HAR_5_N_NODES (7)
 ...
 */
AI_API_ENTRY
ai_error ai_har_5_get_error(ai_handle network);
 ...
 * using @ref ai_har_5_get_error
 */
AI_API_ENTRY
ai_bool ai_har_5_init(
 ...
 * header generated by the code generation tool. See AI_HAR_5_*
 * defines into file @ref har_5.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
