...
#define AI_NET_OBJ_INSTANCE g_har_5
 
#undef AI_HAR_5_MODEL_SIGNATURE
#define AI_HAR_5_MODEL_SIGNATURE     "3b8ce54c1a2845a57ad45ed40af9fbe7"
...
#define AI_TOOLS_DATE_TIME   "Fri Dec 10 20:20:37 2021"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_HAR_5_N_BATCHES
#define AI_HAR_5_N_BATCHES         (1)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 24576, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_HAR_5_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_HAR_5_OUT_NUM, &dense_3_nl_output),
  &conv2d_1_layer, 0, NULL)



AI_DECLARE_STATIC
ai_bool har_5_configure_activations(
...
AI_DECLARE_STATIC
ai_bool har_5_configure_weights(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)
  AI_UNUSED(net_ctx)
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_HAR_5_MODEL_NAME,
      .model_signature   = AI_HAR_5_MODEL_SIGNATURE,
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= har_5_configure_weights(net_ctx, params);
  ok &= har_5_configure_activations(net_ctx, params);
...
AI_API_ENTRY
ai_i32 ai_har_5_forward(ai_handle network, const ai_buffer* input)
{
